...
```{r output-variables}
outputDir <- "quality_control_plots/"
dataCacheDir <- "data_cache/"
inputFilenamePrefix <- "2020_12_07_PostAnno_"
outputFilenamePrefix <- "2020_12_07_PostAnno_"
```
...
```{r load-base-data}
immdata_all <- readRDS(paste0(dataCacheDir,  inputFilenamePrefix, "immdata_all.rds"))
noNormEset <- readRDS(paste0(dataCacheDir, inputFilenamePrefix, "noNormEset.rds"))
```
...
for(ageGroupName in names(ageGroups)){
  ...
  filename <- paste0(dataCacheDir, outputFilenamePrefix, fullSuffix)
...
library(tidyverse)
allEset <- readRDS(paste0(dataCacheDir, outputFilenamePrefix, "all_noNorm_noResponse_eset.rds"))
...
young <- readRDS(paste0(dataCacheDir, outputFilenamePrefix, "young_norm_noResponse_eset.rds"))
...
old <- readRDS(paste0(dataCacheDir, outputFilenamePrefix, "old_norm_noResponse_eset.rds"))
...
extendedOld <- readRDS(paste0(dataCacheDir, outputFilenamePrefix, "extendedOld_norm_noResponse_eset.rds"))
