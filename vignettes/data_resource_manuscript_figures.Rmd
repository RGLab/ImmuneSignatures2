...
### A: 
HIPC Signatures Study creation Pipeline and Study Demographics. 

```{r overview, echo=FALSE, fig.cap="my caption", out.width = '90%', eval = FALSE}
figure1a <- "/Users/joannarce/Dropbox (BCH)/HIPC/IOF/Figures/HIPCFigure.png"
...
## Consort diagram
```{r consort, echo=FALSE, fig.cap="my caption", out.width = '90%', eval = FALSE}
consort <- "/Users/joannarce/Dropbox (BCH)/HIPC/IOF/Figures/IOFConsortTable.png"
knitr::include_graphics(consort)
```

# Figure 2: QC
## Array Quality Figure
```{r arrayquality, echo=FALSE, fig.cap="my caption", out.width = '90%', eval = FALSE}
array <- "/Users/joannarce/Dropbox (BCH)/HIPC/IOF/Figures/arrayquality.png"
knitr::include_graphics(array)
```
