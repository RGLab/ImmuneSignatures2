...
noRespGEFile <- list.files(path       = dataCacheDir,
                           pattern    = paste0(datePrefix,"_extendedOld_norm_noResponse_eset.rds"),
                           full.names = TRUE)
old.NoResp <- readRDS(file = noRespGEFile)

noRespGEFile <- list.files(path       = dataCacheDir,
                           pattern    = paste0(datePrefix,"_young_norm_noResponse_eset.rds"),
                           full.names = TRUE)
young.NoResp <- readRDS(file = noRespGEFile)

withRespGEFile <- list.files(path       = dataCacheDir,
                             pattern    = paste0(datePrefix,"_young_norm_withResponse_eset.rds"),
                             full.names = TRUE)
...
pvcaCacheFile <- "data_cache/pvca.rds"
