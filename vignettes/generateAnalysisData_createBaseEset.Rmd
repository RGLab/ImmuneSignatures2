...
# Gender Imputation using Y-Chromosome associated genes
...
# Subjects that have samples with differing assignments are labeled "NP" 
problemSamples <- noNormEset[ , noNormEset$gender_imputed == "NP"]
problemSubjectsPlot <- qualityControl.genderByMatrix(problemSamples, 
                                                         returnObject = "probSubjects")
probStudiesBySubjectTbl <- qualityControl.createSubjectsByStudyTable(problemSamples$participant_id)

# Studies with "NP" subjects
# SDY1260 SDY1264 SDY1325 SDY1364 SDY1370  SDY180  SDY400   SDY63   SDY67   SDY80  SDY984 
#      1       2       4       1       2       7       1       1       9       5      22 

# All these subjects are removed as they likely have samples that are mixed up with other subjects
noNormEset <- removeSubjectsWithoutGenderConsensus(noNormEset, 
                                                   unique(problemSamples$participant_id))
