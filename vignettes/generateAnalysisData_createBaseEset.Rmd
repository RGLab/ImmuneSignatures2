...
# Gender Imputation Cases:
# 1. Gender at all timepoints is different from original - clinical error - switch
# 2. Some timepoints have different assigned gender - use original gender reported as canonical, and then flag samples as "failedGenderQC"
# 3. Studies without gender_reported and with poor differentiation, mark as "failedGenderQC"
noNormEset <- imputeGender.useAllTimepoints(noNormEset)
noNormEset <- adjustProblemStudies(noNormEset, c("SDY1325", "SDY1370"))
