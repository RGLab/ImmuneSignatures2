...
knitr::opts_chunk$set(echo = TRUE, 
                      ...
                      warning = FALSE, 
                      cache = TRUE,
                      cache.path = file.path("/share/files/HIPC/IS2/@files/data/data_resource_cache/report_cache/"))
```  
...
pdata_df <- rbind(pData(young.NoResp), pData(old.NoResp))
...
```    
<img src="/_webdav/HIPC/IS2/%40files/data/images/euler.png" width="50%">
...
nabFC_28vs0 <- nab2 %>% 
  ...
  ungroup () %>%
  filter(complete.cases (.)) %>%
  spread (study_time_collected, nabval) %>%
