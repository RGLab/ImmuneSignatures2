...
```{r hipciof, echo=FALSE, fig.align='center', out.width='90%'}
knitr::include_graphics(system.file("manuscript_figures/img/HIPCIOF.png", package = "ImmuneSignatures2"))
```
...
```{r flowdiagramiof, echo=FALSE, fig.align='center', out.width='90%'}
knitr::include_graphics(system.file("manuscript_figures/img/flowdiagramIOF.png", package = "ImmuneSignatures2"))
```
...
```{r figure3a, echo=FALSE, fig.align='center', out.width='50%'}
knitr::include_graphics(system.file("manuscript_figures/img/Figure3a.jpg", package = "ImmuneSignatures2"))
```
...
```{r summaryiof, echo=FALSE, fig.align='center', out.width='70%'}
knitr::include_graphics(system.file("manuscript_figures/img/SummaryIOF.png", package = "ImmuneSignatures2"))
```
